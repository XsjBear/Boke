(function($){
	...
	function replyClick(el){
		el.parent().parent().append("<div class='replybox'><textarea cols='80' rows='1' placeholder='来说几句吧......' class='mytextarea' ></textarea><span class='send'>发送</span></div>")
		.find(".send").click(function(){
			...
			if(content != ""){
				...
				console.log("Object" + obj.replyName + "  " + obj.replyName+ "  " + obj.content);
				$(".replybox").remove();
